...
INSERT INTO `asset` VALUES (1,'sn1','host12','centos 7.0 x64','192.168.1.2',1,'dell','Xen',2,25,500,'2016-11-11','2025-11-11','docker','xxx',0),(2,'sn2','host2','bsd','192.168.1.21',2,'hp','test',4,2,256,'2016-11-02','2016-11-16','test','test',1),(3,'sn3','host3','win','192.168.1.23',1,'ibm','test',4,2,256,'2016-11-16','2016-11-20','test','test',1),(16,'sn3defsadfasdf','host3','win','192.168.1.23',1,'ibm','test',4,2,256,'2016-11-16','2016-11-20','test','test',1);
...
INSERT INTO `log` VALUES ('1.1.1.1','http://localhost/',200),('1.1.1.1','http://localhost/',400),('1.1.1.1','http://localhost/',400),('1.1.1.1','http://localhost/',400),('1.1.1.2','http://localhost/',400),('1.1.1.2','http://localhost/users/',200);
...
INSERT INTO `user` VALUES (1,'zrd','e10adc3949ba59abbe56e057f20f883e',23),(2,'kk','e10adc3949ba59abbe56e057f20f883e',29),(3,'kk12345','e10adc3949ba59abbe56e057f20f883e',29),(5,'test','e10adc3949ba59abbe56e057f20f8d32',24);
...
-- Dump completed on 2016-11-27  0:25:49
