...
def user_view():
    ...
    return render_template('user_view.html',username=user.get('name', ''),age=user.get('age', ''),id=user.get('id', ''),department=user.get('department', '1'),email=user.get('email', ''),hobby=user.get('hobby', ['basketball','pingpang']),detail=user.get('detail', ''))
